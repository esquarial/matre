...
final class Version20260524120000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE matre_test_runs ADD original_run_id INT DEFAULT NULL, ADD retry_attempt SMALLINT NOT NULL DEFAULT 0, ADD retry_test_ids TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matre_test_runs DROP COLUMN original_run_id, DROP COLUMN retry_attempt, DROP COLUMN retry_test_ids');
